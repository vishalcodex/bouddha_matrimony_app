            ...
            Expanded(
              child: Padding(
                ...
                child: MyListView(
                  children: [
                    TextView(
                      text: package.packAmmount.toString(),
                      fontSize: 16,
                    ...
                    TextView(
                      text:
                          "${translations.interest.tr} : ${package.totalInterest}",
                      fontSize: 14,
                      color: ColorPallete.secondary,
                      alignment: TextAlign.center,
                      weight: FontWeight.w500,
                    ...
                    TextView(
                      text:
                          "${translations.chatRequest.tr} : ${package.totalChat}",
                      fontSize: 14,
                      color: ColorPallete.secondary,
                      alignment: TextAlign.center,
                      weight: FontWeight.w500,
                    ...
                    TextView(
                      text:
                          "${translations.contactViews.tr} : ${package.totalContact} days",
                      fontSize: 14,
                      color: ColorPallete.secondary,
                      alignment: TextAlign.center,
                      weight: FontWeight.w500,
                    ...
                    TextView(
                      text:
                          "${translations.planDuration.tr} :  ${package.duration} days",
                      fontSize: 14,
                      color: ColorPallete.secondary,
                      alignment: TextAlign.center,
                      weight: FontWeight.w500,
