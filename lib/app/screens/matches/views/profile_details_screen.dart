...
class ProfileDetailsScreen extends GetView<MatchController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: TextView(
          text: translations.profileDetails.tr,
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          TextView(
                                            text: translations.sendInterest.tr,
                                            color: ColorPallete.theme,
                                            fontSize: 14,
                                            weight: FontWeight.bold,
                                          )
  ...
  void launchUrl(Uri telLaunchUri) {}
}
