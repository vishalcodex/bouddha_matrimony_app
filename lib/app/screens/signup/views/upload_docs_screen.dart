                ...
                children: [
                                    ...
                                    child: Center(
                                      child: TextView(
                                        text: controller.isAuthenticated.value
                                            ? translations.updateIDProof.tr
                                            : translations.uploadIDProof.tr,
                                        color: ColorPallete.theme,
                                        fontSize: 22,
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: MyListView(
                        children: [
                          TextView(
                            text: translations.pleaseProvideProofDesc.tr,
                          ...
                          Padding(
                            ...
                            child: TextView(
                              text: translations.uploadIdProofAadhar.tr,
                              color: ColorPallete.primary,
                              fontSize: 14,
                              weight: FontWeight.bold,
                            ),
                              ...
                              child: controller.idProof.value != ""
                                  ...
                                  : RoundedContainer(
                                      ...
                                      child: Padding(
                                        ...
                                        child: TextView(
                                          text: translations.uploadProof.tr,
                          ...
                          Padding(
                            ...
                            child: TextView(
                              text: translations.uploadYourPhoto.tr,
                              color: ColorPallete.primary,
                              fontSize: 14,
                              weight: FontWeight.bold,
                            ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        TextView(
                            text: "* ${translations.allFieldsMandatory.tr}")
                      ],
                    ),
                  ),
                  Row(
