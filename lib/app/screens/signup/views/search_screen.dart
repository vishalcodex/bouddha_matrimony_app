                                  ...
                                  Padding(
                                    ...
                                    child: MyListView(
                                      children: [
                                        ...
                                        // ),
                                        TextView(
                                          text: translations.maritalStatus.tr,
                                          fontSize: 16,
                                          color: ColorPallete.primary,
                                        ),
                                        MyFormField(
                                          fieldName:
                                              translations.maritalStatus.tr,
                                          showFieldName: false,
                                          type: InputType.DROP_DOWN,
                                          keyboard: TextInputType.text,
                                          dropDownOptions:
                                        ...
                                        TextView(
                                          text: translations.mothertounge.tr,
                                          fontSize: 16,
                                          color: ColorPallete.primary,
                                        ),
                                        MyFormField(
                                          fieldName:
                                              translations.mothertounge.tr,
                                          showFieldName: false,
                                          type: InputType.DROP_DOWN,
                                          keyboard: TextInputType.text,
                                        ...
                                        Row(
                                          children: [
                                            Expanded(
                                              child: MyFormField(
                                                fieldName: translations.fromAge,
                                                showFieldName: false,
                                                type: InputType.DROP_DOWN,
                                        ...
                                        TextView(
                                          text: translations.education.tr,
                                          fontSize: 16,
                                          color: ColorPallete.primary,
                                        ),
                                        MyFormField(
