                    ...
                    child: InkWell(
                      ...
                      child: RoundedContainer(
                        ...
                        child: Padding(
                          ...
                          child: Center(
                            child: TextView(
                              text: translations.upgradeNow.tr,
                              color: ColorPallete.theme,
                              weight: FontWeight.bold,
                              fontSize: 14,
                            ),
              ...
              child: Padding(
                ...
                child: MyListView(
                  ...
                  children: [
                    ...
                    DrawerItem(
                        icon: Icons.edit,
                        title: translations.profileEdit.tr,
                        onPressed: () {
                    ...
                    DrawerItem(
                        icon: Icons.favorite,
                        title: translations.interest.tr,
                        onPressed: () {
                          Get.toNamed(
                            Routes.INTERESTS,
                          );
                    ...
                    DrawerItem(
                        ...
                        title: translations.blockedProfile.tr,
                        onPressed: () {
                          Get.toNamed(
                    ...
                    DrawerItem(
                        ...
                        title: translations.newsUpdates.tr,
                        onPressed: () {
                          Get.toNamed(
                            Routes.NEWS_UPDATES,
                          );
